...
dem_data = rasterio.open(r"C:\Users\User\Documents\azhar_local_code\ikeja\tiff\dem_2.tif")
...
# print(f"pixel size x: {pixel_size_x_deg}, pixel size y: {pixel_size_y_deg}")
...
# pixel_size_x_m = pixel_size_x_deg 
# pixel_size_y_m = pixel_size_y_deg 
# # print(f"pixel size x: {pixel_size_x_m}, pixel size y: {pixel_size_y_m}")
...
# # Write the masked visibility array to a new TIF file
