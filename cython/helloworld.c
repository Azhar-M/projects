...
static const char __pyx_k_Hello_worlds[] = "Hello worlds";
...
typedef struct {
  ...
  #if CYTHON_USE_MODULE_STATE
  #endif
  PyObject *__pyx_kp_s_Hello_worlds;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  #endif
  Py_CLEAR(clear_module_state->__pyx_kp_s_Hello_worlds);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  #endif
  Py_VISIT(traverse_module_state->__pyx_kp_s_Hello_worlds);
...
#if CYTHON_USE_MODULE_STATE
#endif
#define __pyx_kp_s_Hello_worlds __pyx_mstate_global->__pyx_kp_s_Hello_worlds
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    {&__pyx_kp_s_Hello_worlds, __pyx_k_Hello_worlds, sizeof(__pyx_k_Hello_worlds), 0, 0, 1, 0},
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Hello_worlds); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 3, __pyx_L1_error)
